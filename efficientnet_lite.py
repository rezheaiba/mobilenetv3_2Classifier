...
efficientnet_lite_params = {
    ...
    'efficientnet_litetiny': [0.5, 0.5, 256, 0.1],
}
...
def efficientnet_lite_tiny(num_classes):
    model_name = 'efficientnet_litetiny'
    return build_efficientnet_lite(model_name, num_classes)
